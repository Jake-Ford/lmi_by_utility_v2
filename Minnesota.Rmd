...
temp_util <- st_read("utility_zones/MN/Service_Areas.shp") %>%
  mutate(new_name = case_when(
    utility == "XCEL" ~ "XCEL", 
    grepl("Minnesota Power", temp_util$utility, ignore.case = TRUE) ~ "Minnesota Power",
    grepl("Otter", temp_util$utility, ignore.case = TRUE) ~ "Otter Tail",
    grepl("NW WI", temp_util$utility, ignore.case = TRUE) ~ "NW WI"
...
map <- leaflet() %>%
  ...
  addCircleMarkers(data = temp_lift,
                   ...
                   popup = ~paste("Program Name: ", Program.Name, "<br>",
                                  ...
                                  "LMI Savings: ", LMI.Customer.Savings.., "<br>",
                                  "Potential LMI Subscribers: ", Potential...LMI.Subscribers),
                   radius = temp_lift$Project.Capacity.KW.AC/125, 
