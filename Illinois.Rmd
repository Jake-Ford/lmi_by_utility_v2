...
# Construct the full URL with the query and limit to 10,000 values
query <- paste0(
  base_url,
  endpoint,
  "?$where=year = 2022 and class != '200' and class != '202' and class != '203' and class != '204' and class != '205' and class != '206' and class != '207' and class != '208' and class != '209' and class != '210' and class != '211' and class != '212' and class != '234' and class != '278' and class != '295' and class != '201' and class != '213' and class != '218' and class != '219' and class != '225' and class != '297' and class != '299' and class != '300' and class != '301' and class != '313' and class != '314' and class != '415' and class != '318' and class != '391' and class != '396' and class != '397' and class != '399' and class != '900' and class != '901' and class != '913' and class != '914' and class != '915' and class != '918' and class != '959' and class != '990' and class != '991' and class != '996' and class != '997'",
  "&$limit=10000"
)
...
leaflet() %>%
  ...
  addLayersControl(
    overlayGroups=c( "Engie", "Engie Parcels", "SFA Parcels", "Combined SFA"),  # Update the order for consistency
    options = layersControlOptions(collapsed = FALSE)
  ) %>%
  hideGroup("Legacy SFA") %>% hideGroup("Current SFA") %>% hideGroup("Combined SFA")
```
